...
<div class="main-container">
            ...
            <div>
                <div class="min-w-full">
                    ...
                    <div class="grid grid-cols-12 text-xs font-bold text-gray-500 border-b border-gray-200 py-3 uppercase">
                        ...
                        <div class="col-span-1 px-3 text-right"></div> 
    ...
    <?php if ($countFolder == 0 && $countFile == 0 && $countSharedFolder == 0 &&$countSharedFile == 0) { ?>
        <div class="text-center mt-20">
            <i class="bi bi-inbox-fill text-6xl text-gray-300 mb-4"></i>
            <h3 class="text-xl font-semibold text-gray-600">Không có tệp hoặc thư mục nào</h3>
